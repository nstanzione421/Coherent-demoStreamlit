...
def create_spark_call(age, w_age, interest, premium):
    request = {}
    inputs['age'] = age
    inputs['income_start_age'] = w_age
    inputs['interest_choice'] = interest
    inputs['premium'] = premium
    request['request_data'] = {'inputs':inputs}
    request['request_meta'] = request_meta
